      ...
      <div className="w-full px-4 lg:px-6">
        <div className="flex justify-between items-center h-18 w-full h-14">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <span className="text-gray-700 font-medium transition-colors duration-300 text-base cursor-default">
        ...
        {isOpen && (
          <div className="md:hidden border-t border-gray-100">
            <div className="px-2 pt-2 pb-4 space-y-2 bg-white">
              ...
              <span className="block px-3 py-2 text-gray-700 font-medium text-base cursor-default">
                {t("nav.marketing-digitale")}
              </span>
            </div>
          </div>
